...
return [
    ...
    'views' => [
        [
            ...
            'data' => [
                ...
                'siteTagline' => "Everything on how to get away with murder",
            ],
            'sort' => -1
        ],
    ...
    'data' => [
		...
		'body_style' => ($this->di->request->getRouteParts()[0]) . '-page',
		
		
        // Stylesheets
        //'stylesheets' => ['css/style.css', 'css/navbar_me.css'],
		'stylesheets' => ['css/anax-grid/style.php', 'css/jquery.fancybox.css'],
        ...
        'javascript_include' => ['js/EpicEditor-v0.2.2/js/epiceditor.min.js', 'js/epiceditor_config.js', 'js/jquery.fancybox.js'],
