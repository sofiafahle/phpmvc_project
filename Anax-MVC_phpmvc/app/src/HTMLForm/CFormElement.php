...
EOD;
        ...
        } elseif ($this['type'] == 'textarea' && $this['id'] == 'textareaEditor') {

            // textarea with epiceditor
            return <<<EOD
<div class="editor-holder">
<label for='$id'>$label</label><br/><a id="markdown" href="#markdown-syntax">Markdown</a>
<div id='epiceditor'></div><div style='display:none'><div id='markdown-syntax'></div></div>
